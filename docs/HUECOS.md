...
| API-12 | Criterio oficial de cálculo para PM sin fila exacta en el cuadro 6, cómo se acredita N2 "media anual" con 30 días, y **qué admite la verificación cuando una persona corrige un dato** (INT-01..05 e **INT-16..18**) | Cálculo; cierre de INT-01..05 e INT-16..18 | Criterios propios declarados como `INT-xx` en la spec; batería de casos para inferir el criterio oficial en cuanto haya sandbox (`docs/05` §7) | Sandbox | Sesiones de prueba oct–nov 2026 |
