...
| # | Entregable | Depende de | Estado |
|---|---|---|---|
| FR0 | Contrato de comandos y lecturas por capacidad en `api/`; sistema de diseño mínimo en `front/compartido/` | S3.1 (HECHO) · stack C1 (**APROBADO**) · A8 de `ADR-005` para persistir `actor.rol` | EN CURSO · pendiente solo de la puerta de calidad |
