...
| FR1 | Workspace `T-REV`: cola y vista de revisión. **Absorbe `S4.4`** | FR0 (HECHO), S3.5 (HECHO) · **y el recálculo tras corrección, que hoy no existe** (`ADR-012` §5 bis) | EN CURSO: contrato y specs hechos; pantallas pendientes |
