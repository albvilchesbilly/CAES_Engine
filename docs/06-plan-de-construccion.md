...
| S3.3 | Manifiesto interno e integridad total | `salida/constructor/`, `tests/` | Manifiesto del caso A verificable; alterar un byte de cualquier adjunto lo detecta; `hash_cabecera` y `hash_detalle` presentes | S3.1 | EN CURSO (19/09/2026, `ADR-008`) |
