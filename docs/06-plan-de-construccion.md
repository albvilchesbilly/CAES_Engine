...
| FR1 | Workspace `T-REV`: cola y vista de revisión. **Absorbe `S4.4`** | FR0 (HECHO), S3.5 (HECHO), S3.8 (HECHO) | EN CURSO: **`FR1.a` y `FR1.b` HECHOS** (23/09/2026, `ADR-014`): la cola tiene capacidad propia (`CAP-17`), `api/` sirve reglas, variables, traza y tareas, y el lazo del recálculo está cerrado. Faltan las **pantallas** (`FR1.c`) |
